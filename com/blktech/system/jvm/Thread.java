...
package com.blktech.system.jvm;
...
public abstract class Thread implements java.lang.Runnable 
{
    ...
    public static void sleep(long millis)
    {
        ...
        {
            Console.getLogger().warn("Thread Wait", ex);
        }
    }
    ...
    public void run()
    {
        ...
        Console.getLogger().info("Thread Started");        
        ...
        try
        {
            this.doThread();
            this.status=ThreadStatus.Stopped;
            Console.getLogger().info("Thread Stopped");
        }
        catch(Exception ex)
        {
            this.status=ThreadStatus.Stopped;            
            Console.getLogger().error("Thread Fail",ex);            
        }                
    }
    ...
    public synchronized void start()
    {
        ...
        Console.getLogger().info("Do Thread '"+this.t.getName()+"' Start");
        this.t.start();
    }
