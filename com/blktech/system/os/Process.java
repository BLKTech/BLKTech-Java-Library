...
package com.blktech.system.os;

import com.blktech.logger.Console;
import com.blktech.system.jvm.Thread;
import com.blktech.system.Terminal;
...
//        this.es=null;
    ...
    {
        super.start();
        while(this.process==null){Thread.sleep(1);}
    }
    ...
    public static Boolean basicCall(String command)
    {
        ...
        while (p.getExitValue()==null){Thread.sleep(100);}
    ...
    public static String basicCallReader(String command)
    {
        ...
        Console.getLogger().debug("Basic Call Reader: " + command);
        ...
        Console.getLogger().debug("Basic Call Reader Res: " + String.valueOf(p.getExitValue()));
