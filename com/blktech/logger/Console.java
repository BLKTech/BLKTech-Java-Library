...
import com.blktech.datatype.ArrayList;
import java.io.File;
...
public class Console implements ILogger{
    ...
    {   
        if (ste!=null)
        {
            ...
            {
                thisC=e.getClassName().endsWith(Console.class.getName());
    ...
    public static ILogger getLogger()
    {
        if (defaultLogger==null)
            defaultLogger=new Console(Thread.currentThread(),"DefaultLogger");
...
//            ex.printStackTrace();
    ...
    public static void loop() {
            ...
            for (Thread t : threadsToLog)
                info+=t.getName() + ">" + getStackTraceElement(t.getStackTrace()[0])+System.lineSeparator();

            com.blktech.system.jvm.Thread.sleep(10);
